...
//      1. Pull all write in ballot data (n)
//      2. Re-encrypt and shuffle, save proof data to db:
//              - Permutation matrix A
//              - List of n random values r
//              - List of n random values g~ (ideally, generated by independent third party)
//              - List of n random values alpha
//              - List of n random values r~
//              - List of n random values p
//              - List of n random values t
//              - List of n random values delta
//              - Random values alpha~, alpha, p, t
//              - Computed values of {g~'}, {w}, {g'}, g~', v, {t}, {v}
//      3. Save shuffled ballots to db
