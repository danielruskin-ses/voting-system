CREATE TABLE IF NOT EXISTS CONFIG(
        ...
        AUDIT_SERVER_PUBLIC_KEY                 BLOB            NOT NULL,
        AUDIT_SERVER_PRIVATE_KEY                BLOB            NOT NULL
);
...
CREATE TABLE IF NOT EXISTS SIGNED_RECORDED_BALLOTS(
...
CREATE UNIQUE INDEX IF NOT EXISTS SIGNED_RECORDED_BALLOTS_ID_IDX ON SIGNED_RECORDED_BALLOTS(VOTER_DEVICE_ID);
